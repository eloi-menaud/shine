...
impl Shell {
    pub fn new() -> Result<Self, ShellError> {
        ...
        info!("temporary dist dir : {}",dist_dir.to_string_lossy().to_string());
        info!("temporary SXML dist file : {}",dist_file.to_string_lossy().to_string());
        Ok(Shell {
